...
abstract public class ClinicalTrialsAttributes {
	private static final String identString = "@(#) $Header: /userland/cvs/pixelmed/imgbook/com/pixelmed/dicom/ClinicalTrialsAttributes.java,v 1.144 2025/01/29 10:58:06 dclunie Exp $";
...
//System.err.println("removeOrNullIdentifyingAttributes(): handleDates != HandleDates.keep");
	...
	protected static void removeOrNullIdentifyingAttributesRecursively(AttributeList list,int handleUIDs,boolean keepDescriptors,boolean keepSeriesDescriptors,boolean keepProtocolName,boolean keepPatientCharacteristics,boolean keepDeviceIdentity,boolean keepInstitutionIdentity,boolean aggregateAgesOver89) throws DicomException {
		...
		if (!keepDescriptors) {	// (001432)
			...
			list.remove(dictionary.getTagFromName("PrincipalDiagnosisCodeSequence"));		// CP 2413
			list.remove(dictionary.getTagFromName("PrimaryDiagnosisCodeSequence"));			// CP 2413
			list.remove(dictionary.getTagFromName("SecondaryDiagnosesCodeSequence"));		// CP 2413
			list.remove(dictionary.getTagFromName("HistologicalDiagnosesCodeSequence"));	// CP 2413
		...
		if (keepPatientCharacteristics) {
			...
			list.remove(dictionary.getTagFromName("EthnicGroupCodeSequence"));	// CP 2356
		...
		list.remove(dictionary.getTagFromName("IssuerOfClinicalTrialProtocolID"));			// CP 2335
		list.remove(dictionary.getTagFromName("IssuerOfClinicalTrialSeriesID"));			// CP 2335
		list.remove(dictionary.getTagFromName("IssuerOfClinicalTrialSiteID"));				// CP 2335
		list.remove(dictionary.getTagFromName("IssuerOfClinicalTrialSubjectID"));			// CP 2335
		list.remove(dictionary.getTagFromName("IssuerOfClinicalTrialSubjectReadingID"));	// CP 2335
		list.remove(dictionary.getTagFromName("IssuerOfClinicalTrialTimePointID"));			// CP 2335
		list.remove(dictionary.getTagFromName("OtherClinicalTrialProtocolIDsSequence"));	// CP 2335
